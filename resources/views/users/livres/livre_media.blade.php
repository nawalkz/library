                            ...
                            <section class="search-filters">
                                <div class="container">
                                    <div class="filter-box">
                                        ...
                                        <form action="http://libraria.demo.presstigers.com/welcome.blade.php" method="get">
                            ...
                            <div class="col-md-9 col-md-push-3">
                                ...
                                <div class="books-gird">
                                    <ul>
                                        <li>
                                            <figure>
                                                <img src="../../assets/img/books-media/gird-view/book-media-grid-01.jpg" alt="Book">
                                                <figcaption>
                                        ...
                                        <li>
                                            <figure>
                                                <img src="../../assets/img/books-media/gird-view/book-media-grid-02.jpg" alt="Book">
                                                <figcaption>
                                                    <p><strong>The Great Gatsby</strong></p>
                                                    <p><strong>Author:</strong> F. Scott Fitzgerald</p>
                                                </figcaption>
                                        ...
                                        <li>
                                            <figure>
                                                <img src="../../assets/img/books-media/gird-view/book-media-grid-03.jpg" alt="Book">
                                                <figcaption>
                                                    <p><strong>The Great Gatsby</strong></p>
                                                    <p><strong>Author:</strong> F. Scott Fitzgerald</p>
                                                </figcaption>
                                        ...
                                        <li>
                                            <figure>
                                                <img src="../../assets/img/books-media/gird-view/book-media-grid-04.jpg" alt="Book">
                                                <figcaption>
                                                    <p><strong>The Great Gatsby</strong></p>
                                                    <p><strong>Author:</strong> F. Scott Fitzgerald</p>
                                                </figcaption>
                                        ...
                                        <li>
                                            <figure>
                                                <img src="../../assets/img/books-media/gird-view/book-media-grid-05.jpg" alt="Book">
                                                <figcaption>
                                                    <p><strong>The Great Gatsby</strong></p>
                                                    <p><strong>Author:</strong> F. Scott Fitzgerald</p>
                                                </figcaption>
                                        ...
                                        <li>
                                            <figure>
                                                <img src="../../assets/img/books-media/gird-view/book-media-grid-06.jpg" alt="Book">
                                                <figcaption>
                                                    <p><strong>The Great Gatsby</strong></p>
                                                    <p><strong>Author:</strong> F. Scott Fitzgerald</p>
                                                </figcaption>
                                        ...
                                        <li>
                                            <figure>
                                                <img src="../../assets/img/books-media/gird-view/book-media-grid-07.jpg" alt="Book">
                                                <figcaption>
                                                    <p><strong>The Great Gatsby</strong></p>
                                                    <p><strong>Author:</strong> F. Scott Fitzgerald</p>
                                                </figcaption>
                                        ...
                                        <li>
                                            <figure>
                                                <img src="../../assets/img/books-media/gird-view/book-media-grid-08.jpg" alt="Book">
                                                <figcaption>
                                                    <p><strong>The Great Gatsby</strong></p>
                                                    <p><strong>Author:</strong> F. Scott Fitzgerald</p>
                                                </figcaption>
                                        ...
                                        <li>
                                            <figure>
                                                <img src="../../assets/img/books-media/gird-view/book-media-grid-09.jpg" alt="Book">
                                                <figcaption>
                                                    <p><strong>The Great Gatsby</strong></p>
                                                    <p><strong>Author:</strong> F. Scott Fitzgerald</p>
                                                </figcaption>
                                        ...
                                        <li>
                                            <figure>
                                                <img src="../../assets/img/books-media/gird-view/book-media-grid-10.jpg" alt="Book">
                                                <figcaption>
                                                    <p><strong>The Great Gatsby</strong></p>
                                                    <p><strong>Author:</strong> F. Scott Fitzgerald</p>
                                                </figcaption>
                                        ...
                                        <li>
                                            <figure>
                                                <img src="../../assets/img/books-media/gird-view/book-media-grid-11.jpg" alt="Book">
                                                <figcaption>
                                                    <p><strong>The Great Gatsby</strong></p>
                                                    <p><strong>Author:</strong> F. Scott Fitzgerald</p>
                                                </figcaption>
                                        ...
                                        <li>
                                            <figure>
                                                <img src="../../assets/img/books-media/gird-view/book-media-grid-12.jpg" alt="Book">
                                                <figcaption>
                                                    <p><strong>The Great Gatsby</strong></p>
                                                    <p><strong>Author:</strong> F. Scott Fitzgerald</p>
                                                </figcaption>
                                ...
                                <aside id="secondary" class="sidebar widget-area" data-accordion-group>
                                    ...
                                    <div class="widget widget_recent_entries">
                                        ...
                                        <ul>
                                            <li>
                                                <figure>
                                                    <img src="../../assets/img/order-item-01.jpg" alt="product" />
                                                </figure>
                                            ...
                                            <li>
                                                <figure>
                                                    <img src="../../assets/img/order-item-02.jpg" alt="product" />
                                                </figure>
                                                <a href="#">The Sonic Boom</a>
                                                <span class="price"><strong>Author:</strong> F. Scott Fitzgerald</span>
                                                <span><strong>ISBN:</strong> 978158157</span>
                                            ...
                                            <li>
                                                <figure>
                                                    <img src="../../assets/img/order-item-03.jpg" alt="product" />
                                                </figure>
                                                <a href="#">The Sonic Boom</a>
                                                <span class="price"><strong>Author:</strong> F. Scott Fitzgerald</span>
                                                <span><strong>ISBN:</strong> 978158157</span>
                        ...
                        <div class="container">
                            ...
                            <div class="team-list">
                                <div class="team-member">
                                    <figure>
                                        <img src="../../assets/img/books-media/staff-pick/staff-picks-01.jpg" alt="Staff Pick" />
                                    </figure>
                                    <div class="content-block">
                                        <div class="member-info">
                                            <div class="member-thumb">
                                                <img src="../../assets/img/books-media/staff-pick/gail.jpg" alt="Katherine">
                                            </div>
                                ...
                                <div class="team-member">
                                    <figure>
                                        <img src="../../assets/img/books-media/staff-pick/staff-picks-02.jpg" alt="Staff Pick" />
                                    </figure>
                                    <div class="content-block">
                                        <div class="member-info">
                                            <div class="member-thumb">
                                                <img src="../../assets/img/books-media/staff-pick/katherine.jpg" alt="Katherine">
                                            </div>
                                            <div class="member-content">
                                ...
                                <div class="team-member">
                                    <figure>
                                        <img src="../../assets/img/books-media/staff-pick/staff-picks-03.jpg" alt="Staff Pick" />
                                    </figure>
                                    <div class="content-block">
                                        <div class="member-info">
                                            <div class="member-thumb">
                                                <img src="../../assets/img/books-media/staff-pick/chris.jpg" alt="Katherine">
                                            </div>
                                            <div class="member-content">
